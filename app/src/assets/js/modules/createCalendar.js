...
export default ()=>{
    ...
    for (const obj of calendar) {
        ...
        dateContainer.insertAdjacentHTML('beforeend',`<div class="date" data-date="${thisdate}"><span>${thisdate}</span></div>`);
